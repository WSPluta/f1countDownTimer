...
export function Content() {
  ...
  return (
    ...
    <div class="oj-flex oj-sm-flex-direction-column oj-sm-3">
      ...
      <span>
        <oj-drawer-popup class="orbr-drawer-end" edge="end" opened={endOpened}>
          <div class="orbr-drawer-header">
            ...
            >
              <span slot="startIcon" class="oj-ux-ico-close orbr-drawer-text-color"></span>
              Close
            </oj-button>
          </div>
          <div class="demo-padding demo-form-container">
            <oj-form-layout>
              <oj-input-text aria-label="line1" value="Line 1" class="orbr-drawer-text-color"></oj-input-text>
              <oj-input-text aria-label="line2" value="Line 2" class="orbr-drawer-text-color"></oj-input-text>
            </oj-form-layout>
          </div>
        </oj-drawer-popup>
      </span>
